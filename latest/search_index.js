...

{
    ...
    "title": "Performance",
    "category": "section",
    "text": "Performance is currently fair. For example, we have used RigidBodySim to perform a 10-second simulation of the humanoid robot Atlas (v5) standing on flat ground with a controller running at 100 Hz in 13 seconds with the Tsitouras 5/4 variable-step integrator on a 3GHz machine."
},
...
{
    "location": "details.html#RigidBodySim.zero_control!",
    "page": "Details",
...
{
    "location": "details.html#RigidBodySim.any_open_visualizer_windows",
    "page": "Details",
    "title": "RigidBodySim.any_open_visualizer_windows",
    "category": "Function",
    "text": "any_open_visualizer_windows()\n\n\nReturn whether any director visualizer windows are open.\n\n\n\n"
},

{
    "location": "details.html#RigidBodySim.new_visualizer_window",
    "page": "Details",
    "title": "RigidBodySim.new_visualizer_window",
    "category": "Function",
...
{
    "location": "details.html#RigidBodyTreeInspector.animate-Tuple{DrakeVisualizer.Visualizer,RigidBodyDynamics.MechanismState,DiffEqBase.ODESolution}",
    "page": "Details",
...
{
    "location": "details.html#RigidBodySim.configuration_renormalizer",
    "page": "Details",
